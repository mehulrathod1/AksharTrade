...
//        holder.lineChart.setLineChartData(data);
        ...
        holder.buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                click.onBuyClick(position);
            }
        });
        holder.sellNow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                click.onSellClick(position);
            }
        });
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView buyNow, sellNow, companyName, stockCategory, stockPrice, profitAndLoss, percentage;
...
//        LineChartView lineChart;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            sellNow = itemView.findViewById(R.id.sellNow);
