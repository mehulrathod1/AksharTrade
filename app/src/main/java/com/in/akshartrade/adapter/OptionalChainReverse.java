...
public class OptionalChainReverse extends RecyclerView.Adapter<OptionalChainReverse.ViewHolder> {
    List<OptionalChainModel> list;
    Context context;
    OptionalChainAdapter.Click click;
    ...
    public OptionalChainReverse(List<OptionalChainModel> list, Context context, OptionalChainAdapter.Click click) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.optional_chain_reverse, parent, false);
